...
export function BarrierBullet01(wpn) {
  wpn.hp = wpn.damage
  delete wpn.damage
}


export function BlankBullet(wpn) {
...
export function BombBullet01(wpn) {
...
export function ClusterBeamAmmo(wpn) {
...
export function ClusterBullet01(wpn) {
...
export function DecoyBullet01(wpn) {
  wpn.hp = wpn.damage
...
// Sabers
export function EfsExposureBullet(wpn) {
  wpn.drain = wpn.burst
  delete wpn.burst
}

export function EfsShieldBullet01(wpn) {
  wpn.duration = wpn.life
}

export function FlameBullet02(wpn) {
  wpn.piercing = true
...
export function GrenadeBullet01(wpn) {
...
export function PileBunkerBullet01(wpn) {
...
export function LaserBullet01(wpn) {
  if([
    'Weapon_ChargeShoot',
...
export function MissileAmmo01(wpn) {
...
// Hammers and Blades
export function ShockWaveBullet01(wpn) {
...
export async function AirRaids(wpn) {
...
export async function SmokeCandleBullet01(wpn) {
  if(raidCategories.includes(wpn.category)) {
    return AirRaids(wpn)
  }
  delete wpn.damage
...
export function SmokeCandleBullet02(wpn) {
  return AirRaids(wpn)
}

export function SolidAmmo01(wpn) {
...
export function SolidPelletBullet01(wpn) {
  if(wpn.piercing) {
    wpn.piercingLife = wpn.custom[0].value
  }
}

export function StunAmmo01(wpn) {
  wpn.duration = wpn.custom[2].value
}

export function SupportUnitBullet01(wpn) {
  wpn.supportType = [
    'life',
    'plasma',
    'guard',
...
export function TargetMarkerBullet01(wpn) {
...
export function Weapon_Drone_MarkerShoot(wpn) {
  const formation = digValue(wpn.wCustom, [ 'drone', 'formation'])
  wpn.units = formation?.length
}

export function Weapon_Gatling(wpn) {
...
export function Weapon_Drone(wpn) {
  const formation = digValue(wpn.wCustom, [ 'drone', 'formation'])
